...
echo "6. Set up Nginx Reverse Proxy (Optional but recommended):"
echo "   sudo apt-get install -y nginx"
echo "   sudo cp $REPO_DIR/nginx.conf /etc/nginx/nginx.conf"
echo "   sudo nginx -t && sudo systemctl reload nginx"

echo ""
echo "7. Run Daily Health Check:"
echo "   chmod +x $REPO_DIR/health_check.sh"
echo "   $REPO_DIR/health_check.sh"
echo ""
