...
-- AddForeignKey
ALTER TABLE "FAQ" ADD CONSTRAINT "FAQ_organisationId_fkey" FOREIGN KEY ("organisationId") REFERENCES "Organisation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FollowUpQuestion" ADD CONSTRAINT "FollowUpQuestion_candidateId_fkey" FOREIGN KEY ("candidateId") REFERENCES "Candidate"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VideoAnswer" ADD CONSTRAINT "VideoAnswer_candidateId_fkey" FOREIGN KEY ("candidateId") REFERENCES "Candidate"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VideoAnswer" ADD CONSTRAINT "VideoAnswer_followupQuestionId_fkey" FOREIGN KEY ("followupQuestionId") REFERENCES "FollowUpQuestion"("id") ON DELETE CASCADE ON UPDATE CASCADE;
